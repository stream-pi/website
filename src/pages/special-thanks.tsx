    ...
    >
      <div className="animate__animated animate__fadeIn">
        ...
        <p className="text-center">
          We are actively working on this page, we want to be sure everyine gets
          their credit!
        </p>
        ...
        <section>
          ...
          <div className="clearfix">
            ...
            <p className="fs-6">
              ...
              thank you. This kind of support allows us to focus on expanding
              and improving our resources to deliver a better experience for
              everyone.
            </p>
            <p className="fs-6">
        ...
        <section>
          ...
          <div className="clearfix">
            ...
            <p className="fs-6">
              Back in 2019, Brady was active in the server, this was back when
              the project had lost a lot of steam.
            </p>
            <p className="fs-6">
            ...
            <p className="fs-6 mb-0">
              In late 2020 into mid 2021 the Project became very active again
              and the team made major amounts of development progress. We owe
              that to Brady for bringing the project back to life and motivating
              Sam and Debayan to start working again.
            </p>
          </div>
        </section>
        <hr />
        <section>
          ...
          <div className="clearfix">
            ...
            <p className="fs-6 mb-0">
              Trideb Dhar - also known as Nevador - made out wonderful logo,
