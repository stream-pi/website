  ...
  return (
    ...
    >
      ...
      <div className="clearfix animate__animated animate__fadeInLeft">
        ...
        <p className="fs-6">
          We are currently looking for a way to list all of our patrons on this
          page!
        </p>
      </div>
      <hr />
      ...
      <div className="clearfix animate__animated animate__fadeInLeft">
        ...
        <p className="fs-6">
          He kept interacting with members of the team, making great suggestions
          and kept pushing us to expand the team. He eventually joined the team
          himself and really improved internal communication
        </p>
